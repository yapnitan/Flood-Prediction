...
class _PersonalInformationViewState extends State<PersonalInformationView> {
  ...
  Future<void> _save() async {
    ...
    final ok = await _authController.updateProfile(id: widget.account.id, name: name);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Personal Information'), centerTitle: true),
      body: SafeArea(
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    enabled: false,
                    controller: TextEditingController(text: widget.account.email),
                    decoration: InputDecoration(
                      labelText: 'Email',
                  ...
                  TextField(
                    enabled: false,
                    controller: TextEditingController(text: widget.account.role),
                    decoration: InputDecoration(
                      labelText: 'Role',
